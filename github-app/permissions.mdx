...
| **Issues** | `read` | Create and update PR summary comments (GitHub's API uses the Issues endpoint for PR comments), list existing comments to avoid duplicates, and add reactions (e.g., :eyes: when a review starts). <img src="/images/repo.issues-permission.png" alt="Issues — Read-only" /> |
