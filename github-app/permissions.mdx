...
| --- | --- | --- |
| **Checks** | `read & write` | Create check runs on the pull request with a findings summary, merge readiness score, and pass/fail status. <img src="/images/repo.checks-permission.png" alt="Checks — Read and write" /> |
