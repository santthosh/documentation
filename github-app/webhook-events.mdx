...
| `installation` | `created` | Registers the installation in DynamoDB |
| `installation` | `deleted` | Marks the installation as removed |
| `installation_repositories` | `added` | Adds repos to the installation record |
| `installation_repositories` | `removed` | Removes repos from the installation record |
