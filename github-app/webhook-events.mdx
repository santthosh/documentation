...
|---|---|---|
| `pull_request` | `opened` | Enqueues a full review |
| `pull_request` | `synchronize` | Enqueues a re-review for the new commits |
| `pull_request` | `reopened` | Enqueues a full review |
