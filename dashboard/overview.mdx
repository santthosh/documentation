...
The MergeWatch dashboard is a Next.js application that provides review history, repository management, and configuration. For self-hosted deployments, it deploys alongside the SAM stack. SaaS users access it at [mergewatch.ai](https://mergewatch.ai).
