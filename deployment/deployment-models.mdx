...
| **Billing** | Free (you pay your LLM provider only) | Free tier (20 PRs/month), then per-PR pricing |
...
<CardGroup cols={2}>
  ...
  <Card title="No infrastructure team?" icon="cloud">
    Choose **Managed SaaS**. Install the GitHub App and you are done. No cloud account, no Docker, no server management. First 20 PRs/month are free.
  </Card>
</CardGroup>
