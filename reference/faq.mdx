...
<AccordionGroup>
  <Accordion title="How does MergeWatch compare to CodeRabbit, Greptile, Copilot, and others?">
    ...
    For detailed side-by-side breakdowns sourced from each vendor's own docs, see [Comparisons](/comparisons/overview) or the [feature matrix](/comparisons/feature-matrix). Per-tool pages: [CodeRabbit](/comparisons/coderabbit), [Greptile](/comparisons/greptile), [GitHub Copilot](/comparisons/github-copilot), [Claude Code](/comparisons/claude-code), [OpenAI Codex](/comparisons/openai-codex), [Cursor BugBot](/comparisons/cursor-bugbot), [Qodo](/comparisons/qodo).
  </Accordion>
